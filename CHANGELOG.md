...
- AI 문자/카톡 생성: Haiku 4.5(SMS·카톡·소프트·후속 4종) + Sonnet 4.6(설득형 1종) 병렬 처리로 분리
  - AI 문자 1회당 원가 약 39% 절감 (₩109 → ₩66)
- 후속연락 전략: Claude Sonnet → Haiku 4.5 전환 (1회 원가 62% 절감, ₩42 → ₩16)
- 요금제 월 한도 조정 (가격 동결, 수익성 확보 목적):
  - AI 문자: 무료 5 / 기본 15 / 프로 50 / 프리미엄 120
  - 스크립트: 무료 3 / 기본 10 / 프로 25 / 프리미엄 45
  - 후속연락: 무료 3 / 기본 10 / 프로 25 / 프리미엄 50
  - PDF: 무료 1 / 기본 2 / 프로 8 / 프리미엄 20

### UI 개선

- 요금제 페이지(`/billing`) 기능 목록을 `plans.ts` 상수 기반 동적 렌더링으로 전환 (하드코딩 제거)
- 랜딩 페이지 요금제 카드도 동일하게 `plans.ts` 동적 참조로 통일
