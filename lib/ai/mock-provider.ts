...
[CHECKLIST]
1. 보장 개시일과 대기기간을 확인했는가
2. 기왕증(과거 병력) 고지 여부를 확인했는가
3. 갱신형/비갱신형 여부를 구분했는가
4. 보험료 납입 면제 조건을 확인했는가

[EXCLUSIONS]
- 90일 대기기간 중 발생한 진단은 보장에서 제외됩니다.
- 기왕증 미고지 시 보험금 지급이 거절될 수 있습니다.
...
[CAUTION]
본 설명은 일반적인 안내이며, 실제 보장 여부는 청약서, 약관 및 인수기준에 따라 달라질 수 있습니다.`,
}
