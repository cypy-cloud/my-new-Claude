...
[KAKAO]
(카카오톡용 메시지 - 이모지 1~2개 포함, 친근하고 자연스럽게, 150~200자)

[SOFT]
(부드러운 버전 - 압박감 없이 배려하는 톤, 200~300자)

[PERSUASIVE]
(강력한 스토리텔링 설득 메시지 - 반드시 700~1000자 분량으로 충분히 길게 작성.
 다음 구조를 반드시 순서대로 따를 것:

 1) [후킹 오프닝] 첫 문장부터 고객의 시선을 사로잡는 질문 또는 공감 문장 1~2줄.
    예: "혹시 이런 경험 있으셨나요?", "많은 분들이 이 사실을 모르고 계세요",
    "최근 {{age_group}} 분들이 가장 많이 후회하는 한 가지가 있어요" 등
    고객의 연령대·직업·상황에 딱 맞게 작성할 것.

 2) [공감 스토리] 고객이 "나 얘기네" 싶을 만한 실제 있을 법한 사례를 3~5문장으로 스토리 형식으로 묘사.
    실명 대신 "비슷한 연령대 고객님", "직장 동료분" 등 3인칭 활용.
    감정이입이 되도록 구체적인 상황, 장소, 감정을 살려 묘사.
    과장·공포 조장 없이 현실적이고 공감 가는 톤으로.
    예: "얼마 전 비슷한 상황의 고객님과 상담했는데, 그분도 처음엔 '설마 내가...' 하셨어요.
    그런데 건강검진 결과지를 받아보신 후, 그 순간 가장 먼저 드신 생각이 '아, 내가 준비를 해뒀어야 했는데'였대요."

 3) [핵심 가치 제안] "특별 보장 내용(후킹 포인트)"에 내용이 있으면 그 내용을 구체적 수치·조건과 함께 자연스럽게 녹여 넣을 것.
    내용이 없으면 {{product_field}} 분야에서 고객이 놓치기 쉬운 보장 공백 1가지를 구체적으로 언급.
    고객이 "이게 뭐지? 더 알고 싶다"는 궁금증이 생기도록 디테일하게.

 4) [지금 확인해야 하는 이유] 지금 이 시점에 알아보는 것이 왜 고객에게 유리한지 1~2문장. 조급함이 아닌 합리적 이유로.

 5) [부드러운 행동 유도] 전화 압박 없이 답장·문의를 유도하는 마무리 2~3줄.
    예: "궁금하신 점 있으시면 편하게 답장 주세요 😊", "부담 없이 여쭤봐도 괜찮아요",
    "짧게 카톡 주시면 맞춤 정보 보내드릴게요" 등.

 이 섹션은 반드시 5단계를 모두 포함하고 700자 이상이어야 합니다.)
