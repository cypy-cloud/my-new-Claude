...
> **AI 스크립트 통합풀**은 AI 상담 스크립트·고객 성향분석·재무설계 간이 리포트·
> AI 상담 후기 작성 4개 기능이 하나의 카운터를 공유함 (`lib/subscription/usage.ts`의 `'script'` feature)
>
> AI 후속연락 추천, 거절극복 스크립트 기능은 제거됨 (거절극복은 AI 상담 스크립트 자체의
> [OBJECTION] 섹션과 기능이 겹쳐 별도 메뉴로 둘 가치가 낮다고 판단, 통합풀 소모만 유발해서 제거)
>
