...
1. **KPN(또는 NHN KCP) 카드사 심사 승인 대기** — 승인 후 Vercel에 실운영 포트원 키
...
2. **생애주기 알림 UI 완성** (Task #24 in_progress)
3. **고객 DB 연동** — 고객 정보 저장/불러오기로 스크립트 자동완성
4. **모바일 UX 개선** — 음성 입력, 결과 공유 등
5. 시연회(7/23·7/24·8/3) 전 전체 기능 점검 — 사용자가 직접 테스트 후 필요 시 요청 예정
