...
import {
  ...
  Bell, BookMarked, MessageCircle, Shield, Rocket, Users, Building2, BarChart2,
} from "lucide-react"
...
export function Sidebar({ profile, planName }: SidebarProps) {
  ...
  return (
    <aside className="hidden md:flex md:flex-col md:w-64 md:fixed md:inset-y-0 bg-[#1e3a5f]">
      ...
      <nav className="flex-1 px-3 py-3 space-y-0.5 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
