...
const PLAN_FEATURES: Record<PlanId, { label: string; included: boolean }[]> = {
  ...
  basic: [
    { label: "AI 문자/카톡 월 20회", included: true },
    { label: "AI 스크립트 월 10회", included: true },
    { label: "PDF 업로드 월 2개", included: true },
    { label: "파일당 10MB", included: true },
    { label: "원본 보관 30일", included: true },
    { label: "블로그·SNS 콘텐츠 월 5회", included: true },
    { label: "뉴스레터 생성 월 2회", included: true },
    { label: "우선 처리", included: false },
    { label: "팀 공유", included: false },
  ],
  pro: [
    { label: "AI 문자/카톡 월 80회", included: true },
    { label: "AI 스크립트 월 30회", included: true },
    { label: "PDF 업로드 월 8개", included: true },
    { label: "파일당 30MB", included: true },
    { label: "원본 보관 180일", included: true },
    { label: "블로그·SNS 콘텐츠 월 20회", included: true },
    { label: "뉴스레터 생성 월 10회", included: true },
    { label: "우선 처리", included: false },
    { label: "팀 공유", included: false },
  ],
  premium: [
    { label: "AI 문자/카톡 월 200회", included: true },
    { label: "AI 스크립트 월 80회", included: true },
    { label: "PDF 업로드 월 20개", included: true },
    { label: "파일당 50MB", included: true },
    { label: "원본 보관 365일", included: true },
    { label: "블로그·SNS 콘텐츠 월 30회", included: true },
    { label: "뉴스레터 생성 월 15회", included: true },
